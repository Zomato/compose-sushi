package com.zomato.sushi.compose.components.calender.core.serializers

import com.zomato.sushi.compose.components.calender.core.Year
import com.zomato.sushi.compose.components.calender.core.format.fromIso8601Year
...
public object YearIso8601Serializer : KSerializer<Year> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("com.zomato.sushi.compose.components.calender.core.Year", PrimitiveKind.STRING)
...
public object YearComponentSerializer : KSerializer<Year> {
    override val descriptor: SerialDescriptor =
        buildClassSerialDescriptor("com.zomato.sushi.compose.components.calender.core.Year") {
            element<Int>("year")
        }
