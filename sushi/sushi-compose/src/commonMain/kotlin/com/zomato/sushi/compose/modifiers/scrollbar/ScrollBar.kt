package com.zomato.sushi.compose.modifiers.scrollbar
...
/**
 * Adds a horizontal scrollbar to a horizontally scrollable component that uses [ScrollState].
 *
 * @param state The [ScrollState] that controls the scrollable component
 * @param reverseScrolling Whether the scrollbar should appear on the opposite side
 * @param autoHide Whether the scrollbar should fade out after scrolling stops
 * @return A [Modifier] that draws a horizontal scrollbar
 */
fun Modifier.drawHorizontalScrollbar(
    state: ScrollState,
    reverseScrolling: Boolean = false,
    autoHide: Boolean = false
): Modifier = drawScrollbar(state, Orientation.Horizontal, reverseScrolling, autoHide)

/**
 * Adds a vertical scrollbar to a vertically scrollable component that uses [ScrollState].
 *
 * @param state The [ScrollState] that controls the scrollable component
 * @param reverseScrolling Whether the scrollbar should appear on the opposite side
 * @param autoHide Whether the scrollbar should fade out after scrolling stops
 * @return A [Modifier] that draws a vertical scrollbar
 */
fun Modifier.drawVerticalScrollbar(
    state: ScrollState,
    reverseScrolling: Boolean = false,
    autoHide: Boolean = false
): Modifier = drawScrollbar(state, Orientation.Vertical, reverseScrolling, autoHide)
...
private fun Modifier.drawScrollbar(
    ...
    orientation, reverseScrolling, autoHide
...
/**
 * Adds a horizontal scrollbar to a horizontally scrollable LazyList component.
 *
 * @param state The [LazyListState] that controls the lazy list component
 * @param reverseScrolling Whether the scrollbar should appear on the opposite side
 * @param autoHide Whether the scrollbar should fade out after scrolling stops
 * @return A [Modifier] that draws a horizontal scrollbar
 */
...
/**
 * Adds a vertical scrollbar to a vertically scrollable LazyList component.
 *
 * @param state The [LazyListState] that controls the lazy list component
 * @param reverseScrolling Whether the scrollbar should appear on the opposite side
 * @param autoHide Whether the scrollbar should fade out after scrolling stops
...
/**
 * Adds a vertical scrollbar to a LazyGrid component.
 *
 * @param state The [LazyGridState] that controls the lazy grid component
 * @param spanCount The number of columns/spans in the grid
 * @param reverseScrolling Whether the scrollbar should appear on the opposite side
 * @param autoHide Whether the scrollbar should fade out after scrolling stops
 * @return A [Modifier] that draws a vertical scrollbar
 */
fun Modifier.drawVerticalScrollbar(
    ...
    Orientation.Vertical, reverseScrolling, autoHide
) { reverseDirection, atEnd, color, alpha ->
    val layoutInfo = state.layoutInfo
    val viewportSize = layoutInfo.viewportEndOffset - layoutInfo.viewportStartOffset
    val items = layoutInfo.visibleItemsInfo
...
private fun Modifier.drawScrollbar(
    ...
    val alpha = if (autoHide) {
        val alpha = remember { Animatable(0f) }
        LaunchedEffect(scrolled, alpha) {
            scrolled.collectLatest {
                alpha.snapTo(1f)
                delay(ScrollBarDelayMs.toLong())
    ...
    Modifier
        ...
        .drawWithContent {
            drawContent()
            onDraw(reverseDirection, atEnd, color, { alpha })
        }
}

private const val ScrollBarFadeDurationMs = 250
private const val ScrollBarDelayMs = 300
...
private val FadeOutAnimationSpec =
    tween<Float>(durationMillis = ScrollBarFadeDurationMs)
