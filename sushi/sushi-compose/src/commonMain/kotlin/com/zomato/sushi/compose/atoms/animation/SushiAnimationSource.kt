...
import com.zomato.sushi.compose.foundation.RawRes
 ...
 */
@JvmInline
value class LottieFileSource(val filePath: String) : LottieResourceSource
 ...
 *
 * @property composition The pre-loaded PlatformLottieComposition object
 */
@JvmInline value class LottieCompositionSource(val composition: PlatformLottieComposition?) : LottieSource