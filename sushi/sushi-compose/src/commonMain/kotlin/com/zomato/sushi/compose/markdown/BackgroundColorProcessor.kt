...
/**
 * Processor that applies custom background colors behind text.
 *
 * This processor recognizes patterns like ==color|Text to highlight== and applies the specified
 * color as background color to the enclosed text. It integrates with the Sushi design system's color system
 ...
 */
class BackgroundColorProcessor() : Processor {
