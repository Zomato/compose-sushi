...
actual val OkraFontFamily: FontFamily = FontFamily(
    Font("com.zomato.sushi.compose.okraThin", { Res.getBytes("font/okra_thin.ttf") }, FontWeight(50)),
    Font("com.zomato.sushi.compose.okraThin", { Res.getBytes("font/okra_thin.ttf") }, FontWeight.W100),
    Font("com.zomato.sushi.compose.okraExtralight", { Res.getBytes("font/okra_extralight.ttf") }, FontWeight.W200),
    Font("com.zomato.sushi.compose.okraLight", { Res.getBytes("font/okra_light.ttf") }, FontWeight.W300),
    Font("com.zomato.sushi.compose.okraRegular", { Res.getBytes("font/okra_regular.ttf") }, FontWeight.W400),
    Font("com.zomato.sushi.compose.okraRegular", { Res.getBytes("font/okra_regular.ttf") }, FontWeight.W500),
    Font("com.zomato.sushi.compose.okraMedium", { Res.getBytes("font/okra_medium.ttf") }, FontWeight.W600),
    Font("com.zomato.sushi.compose.okraSemibold", { Res.getBytes("font/okra_semibold.ttf") }, FontWeight.W700),
    Font("com.zomato.sushi.compose.okraBold", { Res.getBytes("font/okra_bold.ttf") }, FontWeight.W800),
    Font("com.zomato.sushi.compose.okraBold", { Res.getBytes("font/okra_bold.ttf") }, FontWeight.W900),
)

actual val WasabiFontFamily: FontFamily = FontFamily(
    Font("com.zomato.sushi.compose.okraThin", { Res.getBytes("font/wasabicons.ttf") })
)
...
private fun Res.getBytes(path: String) = runBlocking { readBytes(path) }