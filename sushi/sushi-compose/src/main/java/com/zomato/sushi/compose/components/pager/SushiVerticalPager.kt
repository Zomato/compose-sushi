...
/**
 * A vertical pager component for the Sushi design system.
 *
 * Use this component to create vertical carousels, scrollable content sections, onboarding flows,
 * or any UI that requires paging through content in a vertical direction.
 *
 ...
 * @param horizontalAlignment Horizontal alignment of each page within the pager
 ...
 * @param reverseLayout Whether the layout should be reversed (bottom to top instead of top to bottom)
...
fun SushiVerticalPager(
    ...
    VerticalPager(
        state = state,
        modifier = modifier.testTag("SushiVerticalPager"),
