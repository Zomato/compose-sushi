...
object SushiTextFieldDefaults {
    ...
    fun outlinedColors(
        ...
        errorTextColor: ColorSpec = SushiTheme.colors.text.error,
        ...
        errorContainerColor: ColorSpec = SushiTheme.colors.surface.disabled,
        ...
        errorIndicatorColor: ColorSpec = SushiTheme.colors.surface.error,
        ...
        errorLeadingIconColor: ColorSpec = SushiTheme.colors.text.error,
        ...
        errorTrailingIconColor: ColorSpec = SushiTheme.colors.text.error,
        ...
        errorPlaceholderColor: ColorSpec = SushiTheme.colors.text.error,
        ...
        errorPrefixColor: ColorSpec = SushiTheme.colors.text.error,
        ...
        errorSuffixColor: ColorSpec = SushiTheme.colors.text.error,
